...
import ua.dp.klio.wiu.BrowseErrorActivity
...
class MainFragment : BrowseSupportFragment() {
    ...
    private suspend fun buildAdapter(): ArrayObjectAdapter {
        ...
        val moviesCategoryTitle = "Фільми"
        val moviesListRowsAdapter = ArrayObjectAdapter(cardPresenter)
        moviesListRowsAdapter.addAll(0, movies)
        ...
        val cartoonsCategoryTitle = "Мультфільми"
        val cartoonsListRowsAdapter = ArrayObjectAdapter(cardPresenter)
    ...
    private inner class ItemViewSelectedListener : OnItemViewSelectedListener {
        override fun onItemSelected(
            ...
            if (item is Movie) {
                ...
                // val currentlySelectedView = itemViewHolder!!.view as ImageCardView
            }
        }
    }
